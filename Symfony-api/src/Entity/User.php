...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Groups(['read:collection','read:emprunt', 'read:dysfonctionnement', 'read:transfert'])]
    private $id;
    ...
    #[Groups(['read:collection', 'write','read:emprunt', 'read:dysfonctionnement', 'read:transfert'])]
    private $nom;
